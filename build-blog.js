...
<head>
  ...
  <style>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-GYTGRMGCSH"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'G-GYTGRMGCSH');
    </script>
</head>
<body>
  ...
  <footer>
    <div class="footer__inner">
      ...
      <div class="footer__col">
        ...
        <nav class="footer__list">
          <a href="mailto:mosstackstudio@gmail.com">mosstackstudio@gmail.com</a>
          <a href="tel:+886980054850">0980-054-850</a>
    ...
    <div class="footer__bottom">
      <div class="footer__bottom-inner">
        ...
        <div class="footer__legal">
          ...
          <span class="footer__taxid">摩斯棧工作室（MosStack Studio）｜統一編號 60983424</span>
          <a href="/privacy">隱私權政策</a>
          <a href="/terms">服務條款</a>
          <a href="/refund">退款政策</a>
          <span class="footer__support">客服信箱 mosstackstudio@gmail.com｜客服電話 0980-054-850（週一至週五 10:00–18:00）</span>
        </div>
      </div>
    </div>
  </footer>
...
const ARTICLES = [
  ...
  {
    title: '民宿官網＋訂房系統：自建 vs OTA，抽成到底怎麼算？（2026）',
    slug: 'bnb-hotel-booking-website-vs-ota',
    date: '2026-08-01',
    category: '預約系統',
    description: 'OTA 抽成到底吃掉多少利潤？2026 年 Booking、Agoda、Airbnb 最新費率一次整理，加上自建訂房官網的費用與回本試算，幫民宿與旅宿老闆算清楚這筆帳。',
    readTime: 8,
  },
  {
    title: '網站改版指南：什麼時候該改、怎麼改才不掉排名？（2026）',
    slug: 'website-redesign-seo-guide',
    date: '2026-08-15',
    category: '技術',
    description: '網站改版最怕排名歸零。這篇整理改版的五大時機訊號、最常掉流量的五個原因，以及上線前中後的 SEO 遷移 SOP，讓你改得安心不掉排名。',
    readTime: 8,
  },
  {
    title: '金流串接怎麼選：綠界 vs 藍新 vs LINE Pay（含串接費用）',
    slug: 'payment-gateway-comparison-taiwan',
    date: '2026-09-01',
    category: '電商',
